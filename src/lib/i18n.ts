...
export const translations = {
  ku: {
    ...
    'landing.feature3Desc': 'مۆدێرن، کلاسیک، بۆڵد، مینیمال، ئێلیگانت، کریەیتیڤ، کۆرپۆرەیت، گرادیەنت — شێوازێک هەڵبژێرە کە لە پیشەی خۆت نوێنەرایەتی بکات',
    ...
    'template.elegant': 'ئێلیگانت',
    'template.creative': 'کریەیتیڤ',
    'template.corporate': 'کۆرپۆرەیت',
    'template.gradient': 'گرادیەنت',
