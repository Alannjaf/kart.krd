            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3px 8px', marginTop: '4px' }}>
              {data.facebook && (
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', minWidth: 0 }}>
                  ...
                  <span style={{ fontSize: '7px', color: '#9ca3af', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }} dir="ltr">{data.facebook}</span>
                </div>
              )}
              {data.instagram && (
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', minWidth: 0 }}>
                  ...
                  <span style={{ fontSize: '7px', color: '#9ca3af', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }} dir="ltr">{data.instagram}</span>
                </div>
              )}
              {data.linkedin && (
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', minWidth: 0 }}>
                  ...
                  <span style={{ fontSize: '7px', color: '#9ca3af', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }} dir="ltr">{data.linkedin}</span>
                </div>
              )}
              {data.twitter && (
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', minWidth: 0 }}>
                  ...
                  <span style={{ fontSize: '7px', color: '#9ca3af', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }} dir="ltr">{data.twitter}</span>
                </div>
              )}
            </div>
          )}
