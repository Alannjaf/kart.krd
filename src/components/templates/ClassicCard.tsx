              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', marginTop: '4px', overflow: 'hidden' }}>
                {data.facebook && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px', minWidth: 0 }}>
                    ...
                    <span style={{ fontSize: '8px', color: '#4b5563', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '45%' }} dir="ltr">{data.facebook}</span>
                  </div>
                )}
                {data.instagram && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px', minWidth: 0 }}>
                    ...
                    <span style={{ fontSize: '8px', color: '#4b5563', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '45%' }} dir="ltr">{data.instagram}</span>
                  </div>
                )}
                {data.linkedin && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px', minWidth: 0 }}>
                    ...
                    <span style={{ fontSize: '8px', color: '#4b5563', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '45%' }} dir="ltr">{data.linkedin}</span>
                  </div>
                )}
                {data.twitter && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px', minWidth: 0 }}>
                    ...
                    <span style={{ fontSize: '8px', color: '#4b5563', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '45%' }} dir="ltr">{data.twitter}</span>
                  </div>
                )}
              </div>
            )}
